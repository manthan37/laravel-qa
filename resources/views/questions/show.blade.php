                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <a title="Click to mark as favorite" class="favorite mt-2  {{ Auth::guest() ? 'off' : ($question->is_favorited ? 'favorited' : '' ) }}" onclick="event.preventDefault(); document.getElementById('favorite-question-{{ $question->id }}').submit();">
                            ...
                            <div class="float-right">
                                ...
                                <div class="media mt-2">
                                    <a href="{{ $question->user->url }}" class="pr-2"><img
                                            src="{{ $question->user->avatar }}" height="32" alt=""></a>
