            ...
            <div class="card-body">
                ...
                <div class="media">
                    <div class="d-flex flex-column vote-controls">
                        ...
                        <a title="Mark this answer as best" class="vote-accepted mt-2">
                    ...
                    <div class="media-body">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="ml-auto">
                                    @can('update',$answer)
                                    <a href="{{ route('questions.answers.edit',[$answer->id,$question->id]) }}" class="btn btn-sm  btn-outline-info">Edit</a>
                                    @endcan
                                    @can('delete',$answer)
                                    <form action="{{ route('questions.answers.destroy',[$answer->id,$question->id]) }}" method="post" class="form-delete">
                                        @method('DELETE')
                                        @csrf
